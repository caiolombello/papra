export const translations = {
  ...
  'meetings.list.search.total-count-with-query': '{{ count }} matching meetings',
  'meetings.list.empty.title': 'No meetings yet',
  ...
  'meetings.details.metadata.source-storage-key': 'Source storage key',
  'meetings.details.metadata.transcript-storage-key': 'Transcript storage key',
  'meetings.details.metadata.created-at': 'Created at',
  'meetings.details.metadata.updated-at': 'Updated at',
  'meetings.details.transcript.title': 'Transcript',
  'meetings.details.transcript.empty': 'No transcript chunks were stored for this meeting.',
  'meetings.details.transcript.unknown-speaker': 'Unknown speaker',
