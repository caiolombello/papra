...
export const translations: Partial<TranslationsDictionary> = {
  ...
  'meetings.list.search.total-count-with-query': '{{ count }} reuniões encontradas',
  'meetings.list.empty.title': 'Nenhuma reunião ainda',
  ...
  'meetings.details.metadata.source-storage-key': 'Chave do arquivo de origem',
  'meetings.details.metadata.transcript-storage-key': 'Chave da transcrição',
  'meetings.details.metadata.created-at': 'Criada em',
  'meetings.details.metadata.updated-at': 'Atualizada em',
  'meetings.details.transcript.title': 'Transcrição',
  'meetings.details.transcript.empty': 'Nenhum chunk de transcrição foi armazenado para esta reunião.',
  'meetings.details.transcript.unknown-speaker': 'Falante desconhecido',
  ...
  'layout.menu.pdf-password-rules': 'Regras de senha de PDF',
